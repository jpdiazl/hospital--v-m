...
public class PacienteController {
    ...
    public ResponseEntity<Paciente> guardar(@RequestBody Paciente paciente) {
        Paciente pacienteNuevo = pacienteService.save(paciente); // Corregido el nombre de variable
    ...
    public ResponseEntity<Paciente> actualizar(@PathVariable Integer id, @RequestBody Paciente paciente) {
        try {
            ...
            Paciente pacienteActualizado = pacienteService.save(pac);
            return ResponseEntity.ok(pacienteActualizado); // Corregido para devolver el paciente actualizado
        } catch (Exception e) {
            return ResponseEntity.notFound().build();
        }
    }
